                ...
                : SizedBox(
                    ...
                    child: BarChart([
                      Series<Food, String>(
                        ...
                        data: List.generate(
                            V2Val.salesPerformanceWeek.value.food!.length,
                            (i) => V2Val.salesPerformanceWeek.value.food![i]),
                      ...
                      Series<Food, String>(
                        ...
                        data: List.generate(
                            V2Val.salesPerformanceWeek.value.beverage!.length,
                            (i) =>
                                V2Val.salesPerformanceWeek.value.beverage![i]),
                        domainFn: (datum, index) =>
                            DateTime.parse(datum.tanggal!).day.toString(),
                        measureFn: (datum, index) =>
                            int.parse(datum.total.toString()),
                      ...
                      Series<Food, String>(
                        ...
                        data: List.generate(
                            V2Val.salesPerformanceWeek.value.other!.length,
                            (i) => V2Val.salesPerformanceWeek.value.other![i]),
                        domainFn: (datum, index) =>
                            DateTime.parse(datum.tanggal!).day.toString(),
                        measureFn: (datum, index) =>
                            int.parse(datum.total.toString()),
