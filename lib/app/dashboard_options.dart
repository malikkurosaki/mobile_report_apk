                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Obx(() => Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Val.tgl1.value.isEmpty?SizedBox.shrink(): Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Card(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Center(
                                      child: Text(
                                        Val.tgl1.value.split(" ")[0].toString(),
                          ...
                          Val.tgl2.value.isEmpty?SizedBox.shrink(): Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Padding(
                                ...
                                Card(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Center(
                                      child: Text(
                                        Val.tgl2.value.split(" ")[0].toString(),
                                        style: TextStyle(color: Colors.white),
                                      ),
                                    ),
                                  ),
