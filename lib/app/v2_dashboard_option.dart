...
class V2DashboardOption extends StatelessWidget {
  ...
  onLoad() async {
    ...
    if (V2Val.dep.value.namaDept == null && dep.value.namaDept == null && V2Val.masterDep.isNotEmpty) {
      dep.value = V2Val.masterDep[0];
    }

    if (V2Val.out.value.kodeOut == null && out.value.namaOut == null && V2Val.masterOut.isNotEmpty) {
